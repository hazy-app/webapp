  ...
  <appInnerContent 
    ...
    <div class="fv-text-center logo-container">
      ...
      <svg 
        ...
        <g class="eyes">
          <path d="M363.79 472.04c17.57-4.12 36.67-4.55 53.54 2.61 8.35 3.49 16.03 8.45 22.92 14.3-6.85 6.66-15.85 10.43-24.71 13.6-14.01 4.71-28.72 7.67-43.53 7.81-14.07-.22-28.72-3.54-40.03-12.31-2.41-1.98-4.76-4.15-6.29-6.91 10.14-10.41 24.25-15.72 38.1-19.1z"/>
          <path d="M559.52 488.97c12.89-11.2 29.2-18.85 46.39-19.72 18.19-.91 36.65 2.94 53 10.96 5.64 2.81 10.85 6.49 15.24 11.03-4.84 7.1-12.6 11.57-20.48 14.55-13.54 5.06-28.38 5.48-42.54 3.27-10.88-1.63-21.62-4.33-31.87-8.34-7.12-2.86-14.2-6.33-19.74-11.75z"/>
        </g>
        <g class="face">
...
export default {
  ...
  mounted() {
    const handler = async () => {
      ...
      this.eyesBlinkTimer = setTimeout(handler, Math.random() * 4000 + 1000)
    }
    handler()
  },
  beforeDestroy() {
